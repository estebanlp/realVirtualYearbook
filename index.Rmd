...
bchart<-gvisColumnChart(df2,options=list(width=950, height=500, vAxis="{title:'Frequency'}"))
print(bchart,'chart')
...
bchart1<-gvisColumnChart(df2,options=list(width=950, height=500, vAxis="{title:'Average Number of months'}"))
print(bchart1,'chart')
