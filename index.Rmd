...
pie4<-gvisGeoChart(pie3,"Var1","Freq",options=list(width=600, height=500))
...
pie2<-gvisGeoChart(pie1,"Var1","Freq",options=list(width=600, height=500))
...
pie2<-gvisPieChart(pie1,options=list(
                    ...
                    pieHole=0.2, chartArea="{left:0,top:0,width:'100%',height:'100%'}", 
                    height="500px",legend="none"))
cat(unlist(pie2$html$chart))
print(pie2,tag="chart")
```
...
```{r echo=FALSE, message=FALSE, results='asis'}
data<-read.csv("data/data_exploratory.csv")
pie1<-as.data.frame(round(table(data$research_3),2))
pie2<-gvisPieChart(pie1,options=list(
                    slices="{5: {offset: 0.2}, 10: {offset: 0.3}}",
                    pieHole=0.2, chartArea="{left:0,top:0,width:'100%',height:'100%'}", 
                    height="500px",legend="none"))
